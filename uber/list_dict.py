...
savings_acct_holders = [
  dict(name=customer['name'], balance=customer['balance'])
  for customer in customers if customer["type"] == "savings"
]
...
# PURE FUNCTION
sorted(customers, key=get_balance, reverse=True)
